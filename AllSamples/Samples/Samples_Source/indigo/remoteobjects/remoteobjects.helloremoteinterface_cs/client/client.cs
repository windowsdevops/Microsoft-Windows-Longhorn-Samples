...
namespace Microsoft.Samples.MessageBus.Quickstarts.RemoteObjects
{
    public class Client
    {
        public static void Main(string[] args)
        {
            ...
            Uri serverPortUri = 
                new Uri("soap.tcp://localhost:46460/RemotableInterface");
            ...
            IRemoteInterface remotedInstance = remManager.GetObject(serverPortUri, new Uri("urn:CustomInterface")) as IRemoteInterface;
